...
public class App 
{
    public static void main( String[] args )
    {
        ...
        //many to many relationship of order and giftcard
        orders1.getGiftCards().add(giftCards1);
        orders1.getGiftCards().add(giftCards2);
        orders2.getGiftCards().add(giftCards1); 
        orders2.getGiftCards().add(giftCards2);
        s.persist(orders1);
        s.persist(orders2);
